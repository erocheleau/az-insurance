...
export declare function validateDateFacetOptions(engine: SearchEngine<ConfigurationSection & SearchSection & DateFacetSection>, options: DateFacetOptions): void;
