...
export declare function validateNumericFacetOptions(engine: SearchEngine<NumericFacetSection & ConfigurationSection & SearchSection>, options: NumericFacetOptions): void;
