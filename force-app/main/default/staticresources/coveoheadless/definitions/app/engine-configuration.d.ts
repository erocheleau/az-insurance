...
import { AnalyticsClientSendEventHook, IRuntimeEnvironment } from 'coveo.analytics';
...
export declare const engineConfigurationDefinitions: SchemaDefinition<EngineConfiguration>;
export declare function getSampleEngineConfiguration(): EngineConfiguration;
