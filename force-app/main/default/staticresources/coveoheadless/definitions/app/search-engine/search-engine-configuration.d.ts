...
export declare const searchEngineConfigurationSchema: Schema<SearchEngineConfiguration>;
/**
 * Creates a sample search engine configuration.
 *
 * @returns The sample search engine configuration.
 */
export declare function getSampleSearchEngineConfiguration(): SearchEngineConfiguration;
