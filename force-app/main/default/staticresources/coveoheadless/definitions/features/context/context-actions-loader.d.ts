...
import { AddContextActionCreatorPayload } from './context-actions';
...
export interface ContextActionCreators {
     ...
     */
    addContext(payload: AddContextActionCreatorPayload): PayloadAction<AddContextActionCreatorPayload>;
    /**
 ...
 */
export declare function loadContextActions(engine: CoreEngine): ContextActionCreators;
