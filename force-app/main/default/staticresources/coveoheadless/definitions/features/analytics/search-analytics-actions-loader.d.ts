...
import { LogFacetBreadcrumbActionCreatorPayload, LogFacetDeselectActionCreatorPayload, LogFacetSelectActionCreatorPayload, LogFacetUpdateSortActionCreatorPayload } from '../facets/facet-set/facet-set-analytics-actions';
...
import { LogQuerySuggestionClickActionCreatorPayload, OmniboxSuggestionMetadata } from '../query-suggest/query-suggest-analytics-actions';
import { QuestionAnsweringDocumentIdActionCreatorPayload } from '../question-answering/question-answering-document-id';
import { SearchEngine } from '../../app/search-engine/search-engine';
export { LogCategoryFacetBreadcrumbActionCreatorPayload, LogFacetBreadcrumbActionCreatorPayload, LogFacetDeselectActionCreatorPayload, LogFacetSelectActionCreatorPayload, LogFacetUpdateSortActionCreatorPayload, LogDateFacetBreadcrumbActionCreatorPayload, LogNumericFacetBreadcrumbActionCreatorPayload, LogQuerySuggestionClickActionCreatorPayload, QuestionAnsweringDocumentIdActionCreatorPayload, };
/**
...
export interface SearchAnalyticsActionCreators {
     ...
     * @returns A dispatchable action.
     */
    logCategoryFacetBreadcrumb(payload: LogCategoryFacetBreadcrumbActionCreatorPayload): AsyncThunkAction<{
        analyticsType: AnalyticsType.Search;
    }, void, AsyncThunkAnalyticsOptions<StateNeededByAnalyticsProvider>>;
    /**
     ...
     * @returns A dispatchable action.
     */
    logFacetBreadcrumb(payload: LogFacetBreadcrumbActionCreatorPayload): AsyncThunkAction<{
        analyticsType: AnalyticsType.Search;
    }, void, AsyncThunkAnalyticsOptions<StateNeededByAnalyticsProvider>>;
    /**
     ...
     * @returns A dispatchable action.
     */
    logFacetDeselect(payload: LogFacetDeselectActionCreatorPayload): AsyncThunkAction<{
        analyticsType: AnalyticsType.Search;
    }, void, AsyncThunkAnalyticsOptions<StateNeededByAnalyticsProvider>>;
    /**
     ...
     * @returns A dispatchable action.
     */
    logFacetUpdateSort(payload: LogFacetUpdateSortActionCreatorPayload): AsyncThunkAction<{
        analyticsType: AnalyticsType.Search;
    }, void, AsyncThunkAnalyticsOptions<StateNeededByAnalyticsProvider>>;
    /**
     ...
     * @returns A dispatchable action.
     */
    logDateFacetBreadcrumb(payload: LogDateFacetBreadcrumbActionCreatorPayload): AsyncThunkAction<{
        analyticsType: AnalyticsType.Search;
    }, void, AsyncThunkAnalyticsOptions<StateNeededByAnalyticsProvider>>;
    /**
     ...
     * @returns A dispatchable action.
     */
    logNumericFacetBreadcrumb(payload: LogNumericFacetBreadcrumbActionCreatorPayload): AsyncThunkAction<{
        analyticsType: AnalyticsType.Search;
    }, void, AsyncThunkAnalyticsOptions<StateNeededByAnalyticsProvider>>;
    /**
     ...
     * @returns A dispatchable action.
     */
    logQuerySuggestionClick(payload: LogQuerySuggestionClickActionCreatorPayload): AsyncThunkAction<{
        analyticsType: AnalyticsType.Search;
    }, void, AsyncThunkAnalyticsOptions<StateNeededByAnalyticsProvider>>;
    /**
     ...
     * @returns A dispatchable action.
     */
    logExpandSmartSnippetSuggestion(payload: QuestionAnsweringDocumentIdActionCreatorPayload): AsyncThunkAction<{
        analyticsType: AnalyticsType.Custom;
    }, void, AsyncThunkAnalyticsOptions<StateNeededByAnalyticsProvider>>;
    /**
     ...
     * @returns A dispatchable action.
     */
    logCollapseSmartSnippetSuggestion(payload: QuestionAnsweringDocumentIdActionCreatorPayload): AsyncThunkAction<{
        analyticsType: AnalyticsType.Custom;
    }, void, AsyncThunkAnalyticsOptions<StateNeededByAnalyticsProvider>>;
}
/**
 ...
 */
export declare function loadSearchAnalyticsActions(engine: SearchEngine): SearchAnalyticsActionCreators;
