...
import { SearchAPIErrorWithExceptionInBody, SearchAPIErrorWithStatusCode } from '../search-api-error-response';
...
export declare type Search = SearchResponseSuccess | SearchAPIErrorWithExceptionInBody | SearchAPIErrorWithStatusCode;
