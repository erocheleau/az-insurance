...
export declare const baseSearchRequest: (req: BaseParam, method: HttpMethods, contentType: HTTPContentType, path: string) => {
    accessToken: string;
    method: HttpMethods;
    contentType: HTTPContentType;
    url: string;
};
export declare const getOrganizationIdQueryParam: (req: BaseParam) => string;
